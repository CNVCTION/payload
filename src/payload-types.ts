...
export interface Product {
  ...
  /**
   * Player featured on this card.
   */
  playerName?: string | null;
  /**
   * Team the player was on when the card was issued.
   */
  team?: string | null;
  sport?:
    | ('baseball' | 'basketball' | 'football' | 'hockey' | 'soccer' | 'mma' | 'racing' | 'wrestling' | 'other')
    | null;
  /**
   * Release year of the card.
   */
  year?: number | null;
  manufacturer?:
    | ('topps' | 'panini' | 'upper-deck' | 'bowman' | 'fleer' | 'donruss' | 'leaf' | 'wild-card' | 'other')
    | null;
  /**
   * Name of the card set or series.
   */
  setName?: string | null;
  /**
  ...
  rarity?: ('common' | 'uncommon' | 'rare' | 'super-rare' | 'ultra-rare' | 'one-of-one' | 'numbered') | null;
  isGraded?: boolean | null;
  grade?:
    | ('psa-10' | 'psa-9' | 'psa-8' | 'psa-7' | 'bgs-10' | 'bgs-95' | 'bgs-9' | 'sgc-10' | 'sgc-95' | 'other')
    | null;
...
export interface Category {
  ...
  description?: string | null;
  /**
   * Lower numbers show first in navigation.
   */
